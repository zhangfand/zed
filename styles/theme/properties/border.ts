...
export function borderStyle({
  ...
  const color =
    (options?.color && themeColor[options.color](intensity)) || DEFAULT_COLOR

  const position = {
    top: mergedOptions.position === "all" || mergedOptions.position === "top",
    bottom:
      mergedOptions.position === "all" || mergedOptions.position === "bottom",
    left: mergedOptions.position === "all" || mergedOptions.position === "left",
    right:
      mergedOptions.position === "all" || mergedOptions.position === "right",
  }
