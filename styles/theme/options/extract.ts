...
export function extractContainerOptions(input: unknown): Partial<ContainerOptions> | null {
  ...
  return Object.keys(result).length > 0 ? result as Partial<ContainerOptions> : null;
}

export function extractTextOptions(input: unknown): Partial<TextOptions> | null {
  if (typeof input !== 'object' || input === null) {
    return null;
  }
  ...
  return Object.keys(validatedResult).length > 0 ? result as Partial<TextOptions> : null;
}
