...
export default function contacts_panel(): any {
    ...
    const subheader_row = toggleable({
        ...
        state: {
            active: {
                default: {
                    ...text(theme.lowest, "mono", { size: "sm" }),
    ...
    const filter_input = {
        background: background(layer, "on"),
        corner_radius: 6,
        text: text(layer, "mono", "base"),
        placeholder_text: text(layer, "mono", "base", "disabled", {
            size: "xs",
        }),
    ...
    return {
        ...
        list_empty_state: toggleable({
            base: interactive({
                base: {
                    ...text(layer, "mono", "variant", { size: "sm" }),
                    padding: {
                        top: SPACING / 2,
                        bottom: SPACING / 2,
                        left: SPACING,
        ...
        extra_participant_label: {
            ...
            background: background(layer, "hovered"),
            ...text(layer, "mono", "hovered", { size: "xs" })
        },
