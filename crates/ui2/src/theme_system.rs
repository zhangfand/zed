...
impl ThemeScales {
    ...
    pub fn iter(&self) -> std::slice::Iter<ScaleType> {
        self.scales.iter()
    }
}
...
impl ThemeScalesBuilder {
    ...
    pub fn add_scale(mut self, scale: Scale) -> Self {
        self.scales.push(ScaleType::Standard(scale));
        self
    }

    pub fn add_custom_scale(mut self, custom_scale: CustomScale) -> Self {
        self.scales.push(ScaleType::Custom(custom_scale));
        self
    }
