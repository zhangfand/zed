use composite_buffer::{
    AnchorRangeExt as _, CompositeAnchor as Anchor, Snapshot as CompositeBufferSnapshot, ToOffset,
};
...
pub struct FoldMap {
    buffer: Mutex<CompositeBufferSnapshot>,
...
impl FoldMap {
    pub fn new(buffer: CompositeBufferSnapshot) -> (Self, Snapshot) {
        let this = Self {
    ...
    pub fn read(
        &self,
        buffer: CompositeBufferSnapshot,
    ...
    fn sync(
        &self,
        new_buffer: CompositeBufferSnapshot,
...
mod tests {
    ...
    use composite_buffer::{CompositeBuffer, ToPoint as _};
    use language::Buffer;
    use rand::prelude::*;
    use std::{env, mem};
        ...
        for _ in 0..operations {
            ...
            match rng.gen_range(0..=100) {
                ...
                _ => buffer.update(cx, |buffer, _| {
                    ...
                    log::info!("editing {:?}", subscription.consume().into_inner());
                }),
            };
            let buffer_snapshot = buffer.read(cx).snapshot();
