use editor::settings::LanguageOverride;
use futures::{stream, SinkExt, StreamExt as _};
use gpui::{executor, font_cache::FontCache};
...
lazy_static! {
    static ref DEFAULT_SETTINGS_JSON: serde_json::Value = serde_json::json! {
