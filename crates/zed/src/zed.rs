...
pub fn initialize_workspace(
    ...
    cx.spawn(|mut cx| async move {
        ...
        let (project_panel, terminal_panel, assistant_panel, channels_panel) =
            futures::try_join!(project_panel, terminal_panel, assistant_panel, channels_panel)?;
        workspace_handle.update(&mut cx, |workspace, cx| {
