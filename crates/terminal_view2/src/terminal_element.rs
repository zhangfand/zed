...
use gpui::{
    black, div, filled, point, px, red, relative, AnyElement, AsyncWindowContext, AvailableSpace,
...
impl LayoutRect {
    ...
    fn paint(&self, origin: Point<Pixels>, layout: &LayoutState, cx: &mut WindowContext) {
        ...
        cx.paint_quad(filled(Bounds::new(position, size), self.color));
    }
}
...
impl Element for TerminalElement {
    ...
    fn paint(self, bounds: Bounds<Pixels>, state: &mut Self::State, cx: &mut WindowContext<'_>) {
        ...
        cx.paint_quad(filled(bounds, layout.background_color));
