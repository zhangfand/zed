...
impl Server {
    ...
    async fn call(
        ...
        let called_user_id = UserId::from_proto(request.payload.recipient_user_id);
        ...
        let incoming_call = proto::IncomingCall {
            ...
            participant_user_ids: room
                ...
                .collect(),
            initial_project: initial_project_id.and_then(|initial_project_id| {
                room.participants
                    .iter()
                    .flat_map(|participant| &participant.projects)
                    .find(|project| project.id == initial_project_id.to_proto())
                    .cloned()
            }),
        };
        let mut calls = self
    ...
    async fn join_channel(
        self: Arc<Self>,
        request: Message<proto::JoinChannel>,
        ...
        self.store()
            .await
            .join_channel(request.sender_connection_id, channel_id);
        let messages = self
            .app_state
            .db
    ...
    async fn send_channel_message(
        ...
        let message = proto::ChannelMessage {
            sender_id: request.sender_user_id.to_proto(),
            id: message_id,
            body,
